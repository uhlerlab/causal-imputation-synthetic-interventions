...
plt.clf()
plt.scatter(statistics_unit["num_donors"], statistics_unit["num_contexts"])
...
plt.clf()
plt.scatter(statistics_iv["num_donors"], statistics_iv["num_contexts"])
...
plt.clf()
plt.scatter(statistics_iv["num_donors"], iv_r2.values, c=statistics_iv["num_contexts"])
plt.xlabel("Number of Donor Actions")
plt.ylabel("$R^2$")
cb = plt.colorbar()
