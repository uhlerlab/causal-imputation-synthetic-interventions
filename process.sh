...
python3 -m processing.filter_inst_info_epsilon.py

# (2) convert the gctx file to a pandas pickle file for faster read/write
python3 -m processing.convert_to_pickle.py
