...
cells_with_dmso = set(inst_info_most_common_orig.query('pert_id == "DMSO"')['cell_id'])
inst_info_most_common = inst_info_most_common_orig[inst_info_most_common_orig['pert_type'] == 'trt_cp']
inst_info_most_common = inst_info_most_common.query('cell_id in @cells_with_dmso')
...
cell_ranks_most_common.to_csv(PERT_RANK_COMMON_FILE)
